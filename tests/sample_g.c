/* sample_g.f -- translated by f2c (version 20100827).
...
/* Main program */ int MAIN__(void)
{
    ...
    static doublereal t, v[5000], w[5000], tac, tic, tol, wsp[273527];
    static integer iwsp[5000], iflag;
    extern doublereal clock_(void);
    static doublereal anorm;
    extern /* Subroutine */ int loadhb_(char *, char *, integer *, integer *, 
	    integer *, integer *, doublereal *, integer *, ftnlen, ftnlen);
    static integer itrace;
    extern /* Subroutine */ int dgccsv_(), dgcoov_();
    ...
    static cilist io___15 = { 0, 6, 0, fmt_9001, 0 };
    ...
    static cilist io___21 = { 0, 6, 0, fmt_9002, 0 };
    static cilist io___22 = { 0, 6, 0, fmt_9002, 0 };
    static cilist io___23 = { 0, 6, 0, fmt_9003, 0 };
    static cilist io___24 = { 0, 6, 0, fmt_9003, 0 };
    ...
    static cilist io___35 = { 0, 6, 0, fmt_9002, 0 };
    static cilist io___36 = { 0, 6, 0, fmt_9002, 0 };
    ...
    static cilist io___77 = { 0, 6, 0, fmt_9001, 0 };
    static cilist io___78 = { 0, 6, 0, fmt_9001, 0 };
    ...
    static cilist io___83 = { 0, 6, 0, fmt_9002, 0 };
    static cilist io___84 = { 0, 6, 0, fmt_9002, 0 };
    static cilist io___85 = { 0, 6, 0, fmt_9003, 0 };
    static cilist io___86 = { 0, 6, 0, fmt_9003, 0 };
    ...
    static cilist io___97 = { 0, 6, 0, fmt_9002, 0 };
    static cilist io___98 = { 0, 6, 0, fmt_9002, 0 };
...
/* ---  compute w = exp(t*A)v with COO format ... */
    tic = clock_();
    dgexpv_(&rmat_1.n, &m, &t, v, w, &tol, &anorm, wsp, &c_b7, iwsp, &c__5000,
	     (U_fp)dgcoov_, &itrace, &iflag);
    tac = clock_();
/* --- */
    s_wsfe(&io___15);
    do_fio(&c__1, "----------------------------------------------------", (
    ...
    e_wsfe();
    s_wsfe(&io___16);
    do_fio(&c__1, "DGEXPV (COO) has completed:", (ftnlen)27);
    e_wsfe();
    s_wsfe(&io___17);
    do_fio(&c__1, "----------------------------------------------------", (
	    ftnlen)52);
...
/* --- */
    ...
    e_wsfe();
    s_wsfe(&io___47);
    do_fio(&c__1, "DGEXPV (CCS) has completed:", (ftnlen)27);
    e_wsfe();
    s_wsfe(&io___48);
    do_fio(&c__1, "----------------------------------------------------", (
	    ftnlen)52);
...
/* ---  convert from CCS to CRS ... */
    dgcnvr_("ccs", "crs", "n", &rmat_1.n, &rmat_1.n, &rmat_1.nz, rmat_1.ia, 
	    rmat_1.ja, rmat_1.a, iwsp, (ftnlen)3, (ftnlen)3, (ftnlen)1);
/* ---  compute w = exp(t*A)v with CRS format ... */
    ...
    e_wsfe();
    s_wsfe(&io___78);
    do_fio(&c__1, "DGEXPV (CRS) has completed:", (ftnlen)27);
    e_wsfe();
    s_wsfe(&io___79);
    do_fio(&c__1, "----------------------------------------------------", (
	    ftnlen)52);
